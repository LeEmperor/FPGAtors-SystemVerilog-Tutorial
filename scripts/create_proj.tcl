...
# Decide whether user passed a part or a board
# Very dumb heuristic: if it starts with 'xc' treat as part, else board
# if {[string match "xc*" $part_or_board]} {
#     set part_name $part_or_board
#     create_project $proj_name $proj_dir -part $part_name -force
# } else {
#     set board_name $part_or_board
#     create_project $proj_name $proj_dir -force
#     set_property board_part $board_name [current_project]
# }
#
# # Set top module (for HDL project)
